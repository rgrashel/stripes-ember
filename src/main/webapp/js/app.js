...
App.ArtistsRoute = Ember.Route.extend({
  model: function() {
    ...
    Ember.$.getJSON('http://localhost:8080/StripesEmber/artists', function(artists) {
  ...
  actions: {
    createArtist: function() {
      ...
      Ember.$.ajax('http://localhost:8080/StripesEmber/artists', {
        type: 'POST',
        dataType: 'json',
...
App.ArtistsSongsRoute = Ember.Route.extend({
  model: function(params) {
    ...
    var url = 'http://localhost:8080/StripesEmber/artists/' + params.slug;
  ...
  actions: {
    createSong: function() {
      ...
      Ember.$.ajax('http://localhost:8080/StripesEmber/songs', {
        type: 'POST',
        dataType: 'json',
        context: this,
